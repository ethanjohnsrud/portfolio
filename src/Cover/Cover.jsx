    ...
    return (<div id='cover-section' ref={passRef} class='container-fluid no-padding no-margin' style={{position: 'relative',  left: 0, right: 0, }}>
        <img src={Background} alt='Desk Code Overlay' class='img-fluid' id='cover-image'/>
            <div id='about-caption'>
                <p id='about-caption-text' style={{opacity: ''}}>Starting with complex conditionals in Excel for my greenhouse businesses, to writing my first ‘Hello World’ program I knew I would flourish in software development. I discovered how thinking through every step, using logic and problem-solving skills within a set of guidelines fits my personality.  I actively engage the power of technology in perusing analytical challenges to develop innovative and optimized solutions.</p>
            </div>
        <h1 id='name'>ETHAN 
        JOHNSRUD</h1>
